...
wan_series = [
    ...
    {
        # Wan2.1-T2V-1.3B with 5 G-buffer modalities (patch_embedding expanded: in_dim 16 -> 96)
        "model_hash": "a87823c16fa5119ca6ef32cefc0be86d",
        "model_name": "wan_video_dit",
        "model_class": "diffsynth.models.wan_video_dit.WanModel",
        "extra_kwargs": {'has_image_input': False, 'patch_size': [1, 2, 2], 'in_dim': 96, 'dim': 1536, 'ffn_dim': 8960, 'freq_dim': 256, 'text_dim': 4096, 'out_dim': 16, 'num_heads': 12, 'num_layers': 30, 'eps': 1e-06}
    },
    {
