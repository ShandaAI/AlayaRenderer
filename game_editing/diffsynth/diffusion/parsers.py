...
def add_output_config(parser: argparse.ArgumentParser):
    ...
    parser.add_argument("--resume_from_checkpoint", type=str, default=None, help="Path to a training checkpoint directory to resume from (contains optimizer/scheduler/training state).")
    return parser
